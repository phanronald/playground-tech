...
export class ImagePreProcessing {

	// internal kernel stuff for the gaussian blur filter
	public blurRadius: any;
	public blurKernelSize: any;
	public blurKernel: any;
	public blurMult: any;

	public preprocessImage = (canvas: HTMLCanvasElement): ImageData => {
		const imageCanvas = canvas.getContext('2d');

		let image: ImageData = {} as ImageData;
		if (imageCanvas != null) {
			image = imageCanvas.getImageData(0, 0, canvas.width, canvas.height);
			this.thresholdFilter(image.data, 0.5);
		}
	...
	public thresholdFilter = (pixels: Uint8ClampedArray, level: number): void => {
		if (level === undefined) {
			level = 0.5;
		}
	...
	public getARGB = (data: any, i: number): any => {
		const offset = i * 4;
		return (
	...
	public setPixels = (pixels: any, data: any): void => {
		let offset = 0;
	...
	// from https://github.com/processing/p5.js/blob/main/src/image/filters.js
	public buildBlurKernel = (r: any): void => {
		let radius = (r * 3.5) | 0;
	...
	// from https://github.com/processing/p5.js/blob/main/src/image/filters.js
	public blurARGB = (pixels: any, canvas: HTMLCanvasElement, radius: any): void => {
	...
	public invertColors = (pixels: any): void => {
	...
	// from https://github.com/processing/p5.js/blob/main/src/image/filters.js
	public dilate = (pixels: any, canvas: HTMLCanvasElement): void => {
		let currIdx = 0;
